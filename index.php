...
if($result = $mysqli->query($query)){
	while($row = $result->fetch_assoc()){
		...
		echo '<li class="nav-item"><a href="#home-section" class="nav-link"><span>'.$row["name"].'</span></a></li>
		<li class="nav-item"><a href="#about-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#resume-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#services-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#skills-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#projects-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#blog-section" class="nav-link"><span></span></a></li>
		<li class="nav-item"><a href="#contact-section" class="nav-link"><span></span></a></li>
		?>';
	}
	$result->free();
}
